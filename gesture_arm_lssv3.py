...
# ║                                                                           ║
# ║  CONFIRMED RANGES:                                                        ║
# ║    lss1  base     :  0 straight | -600 right  | +600 left                ║
# ║    lss2  shoulder :  0 up       | -900 parallel with ground              ║
...
PICKUP_SEQUENCE_1 = [
    ...
    # Step 1: open claw fully (confirmed 600)
    {"lss5": 600, "wait": 1.2},

    # Step 2: swing base left, lift shoulder to safe travel height
    {"lss1": -600,  
     "lss2": -200, 
     "lss3": -100, 
     "lss4": -750, 
    ...
    # Step 5: shoulder near parallel (-850), elbow bent hard inward
    {"lss2": -850, "lss3": -780, "lss4": -200, "wait": 2.0},

    # Step 6: final depth push — elbow at max, wrist nearly flat to table
    ...
    # Step 8: lift elbow slightly to clear table with item
...
PICKUP_SEQUENCE_2 = [
    ...
    # Step 2: swing base right, lift shoulder to safe travel height
